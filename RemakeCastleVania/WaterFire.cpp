...
void CWaterFire::setPosition(float _x, float _y, int _nx)
{
	...
	if (nx > 0)
		...
		CGameObject::SetPosition(_x + SIMON_BBOX_WIDTH - SIMON_PADDING_WEAPON_ATTACK_WATERFIRE_X*2, _y + SIMON_PADDING_WEAPON_ATTACK+ SIMON_PADDING_WEAPON_ATTACK_WATERFIRE_Y);
